...
window.feedback = (() => {
    ...
    function _requestPage(method:string, url:string, data:any, onsuccess, onerror) {
    ...
    function _send() {
        ...
        const privacy:boolean = document.getElementById("feedback-privacy")?.checked;
        const deleteIssue:boolean = document.getElementById("feedback-delete")?.checked;
