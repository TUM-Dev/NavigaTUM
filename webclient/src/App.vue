        ...
        <div class="column col-8 col-lg-11 col-mx-auto">
          <div class="form-autocomplete">
            ...
            <ul
              ...
              v-bind:class="{
                'd-none':
                  !search.focused || search.autocomplete.sections.length == 0,
              }"
              v-cloak
            >
              ...
              <template v-for="s in search.autocomplete.sections">
                ...
                <li
                  ...
                  v-if="
                    s.n_visible === undefined ||
                    (s.n_visible !== undefined && i < s.n_visible) ||
                    s.expanded
                  "
                  class="menu-item"
                >
                  <a
                    v-bind:class="{
                      active: e.id == search.autocomplete.highlighted,
                    }"
