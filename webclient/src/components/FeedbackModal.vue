...
function _assuereTokenValidity() {
  ...
  if (
    token.value === null ||
    Date.now() - token.value.creation > 1000 * 3600 * 6
  ) {
    _requestPage(
      "POST",
  ...
  _requestPage(
    ...
    (r) => {
      ...
      if (r.status === 201) {
        ...
        const unexpectedStatusError = t(
          "feedback.error.send_unexpected_status"
        );
      ...
      <div class="modal-body">
        <div class="content">
          ...
          <div class="form-group">
            <div
              id="feedback-coordinate-picker-helptext"
              class="d-none toast toast-primary"
            >
              {{ $t("feedback.coordinatepicker.helptext") }}
            </div>
            <label class="form-label" for="feedback-subject">
      ...
      <div class="modal-body">
        <div class="content">
          ...
          <p>
            ...
            <a
              id="feedback-success-url"
              class="btn-link"
              v-bind:href="successUrl.value"
              >{{ $t("feedback.success.this_issue") }}</a
            >
          </p>
          <div class="buttons">
