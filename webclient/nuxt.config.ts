...
"logo": "https://nav.tum.de/logos/org_logo.svg"
  ...
  routeRules: {
    ...
    // Location pages: use ISR (incremental static regeneration) with revalidation
    // Don't cache 404s, but cache successful responses for 1 hour
    "/view/**": { isr: 3600 },
    "/campus/**": { isr: 3600 },
    "/site/**": { isr: 3600 },
    "/building/**": { isr: 3600 },
