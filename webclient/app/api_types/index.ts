...
export type components = {
	schemas: {
		...
		readonly ComputedPropResponse: {
			readonly extra?:
				| null
				| components["schemas"]["ExtraComputedPropResponse"];
			readonly name: string;
		...
		readonly CoordinateResponse: {
			readonly accuracy?:
				| null
				| components["schemas"]["CoordinateAccuracyResponse"];
			/**
			 * Format: double
			 * @description Latitude
			 * @example 48.26244490906312
		...
		readonly LocationDetailsResponse: {
			 ...
			 */
			readonly imgs?:
				| readonly components["schemas"]["ImageInfoResponse"][]
				| null;
		...
		readonly ManeuverResponse: {
			...
			readonly transit_info?:
				| null
				| components["schemas"]["TransitInfoResponse"];
		...
		readonly MapsResponse: {
			...
			readonly roomfinder?:
				| null
				| components["schemas"]["RoomfinderMapResponse"];
		};
		...
		readonly SectionsResponse: {
			...
			readonly featured_overview?:
				| null
				| components["schemas"]["FeaturedOverviewResponse"];
			readonly rooms_overview?:
				| null
				| components["schemas"]["RoomsOverviewResponse"];
		};
		readonly Source: {
