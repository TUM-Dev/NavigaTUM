...
import type { AddressResultEntry } from "~/utils/lectureRow";

defineProps<{
  item: AddressResultEntry;
  highlighted: boolean;
}>();
...
<template>
  <!-- Addresses have no entity route, so the row is plain and non-navigable. -->
  <li
  ...
  >
    <AddressResultContent :item="item" :highlighted="highlighted" />
  </li>
</template>
