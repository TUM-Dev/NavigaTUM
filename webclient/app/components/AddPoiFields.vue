...
<template>
  <div class="space-y-3">
    <div>
      <label class="text-zinc-600 mb-1 block text-xs font-medium" for="add-poi-name">
    ...
    <div>
      <label class="text-zinc-600 mb-1 block text-xs font-medium" for="add-poi-usage">
        {{ t("short_description") }} <span class="text-red-700">*</span>
      </label>
      <input
        id="add-poi-usage"
        ...
        class="focusable bg-zinc-200 border-zinc-400 text-zinc-900 w-full rounded border px-2 py-1 text-sm"
      />
      <I18nT keypath="short_description_help" tag="p" class="text-zinc-500 mt-1 text-xs">
    ...
    <details class="border-zinc-300 rounded border px-3 py-2">
      ...
      <div class="mt-3 space-y-3">
        <div>
          <span class="text-zinc-600 mb-1 block text-xs font-medium">{{ t("comment") }}</span>
          <div class="space-y-2">
            <textarea
              v-model="editProposal.pendingAddition.comment_de"
              :placeholder="t('comment_de')"
              rows="2"
              class="focusable bg-zinc-200 border-zinc-400 text-zinc-900 w-full resize-y rounded border px-2 py-1 text-sm"
            />
            <textarea
        ...
        <div>
          <span class="text-zinc-600 mb-1 block text-xs font-medium">{{ t("generic_props") }}</span>
          <p class="text-zinc-500 mb-2 text-xs">{{ t("generic_props_help") }}</p>
