...
Also, new external data might break the scripts from time to time, as either the external data has errors or we make assumptions here that turn out to be wrong.
